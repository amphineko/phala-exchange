...
declare module '@polkadot/api/types/errors' {
  export interface AugmentedErrors<ApiType> {
    ...
    phaClaim: {
       ...
       **/
      CallerNotRelayer: AugmentedError<ApiType>;
      /**
       ...
       **/
      LessThanEndHeight: AugmentedError<ApiType>;
      /**
       * The module doesn't set relyer
       **/
      NoRelayer: AugmentedError<ApiType>;
      /**
       * The relayer has not been changed
       **/
      RelayerNotChanged: AugmentedError<ApiType>;
      /**
       * The transaction has been claimed
       **/
      TxAlreadyClaimed: AugmentedError<ApiType>;
      /**
       * The transaction hash already exist
       **/
      TxHashAlreadyExist: AugmentedError<ApiType>;
      /**
       * The transaction hash doesn't exist
       **/
      TxHashNotFound: AugmentedError<ApiType>;
    };
    phalaModule: {
      [key: string]: AugmentedError<ApiType>;
      /**
      ...
      BadMachineId: AugmentedError<ApiType>;
      /**
       * Wrong sequence number of a message
       **/
      BadMessageSequence: AugmentedError<ApiType>;
      /**
       ...
       * `Currency` module
       **/
      CannotWithdraw: AugmentedError<ApiType>;
      /**
       * Controller not found
       **/
      ControllerNotFound: AugmentedError<ApiType>;
      FailedToVerify: AugmentedError<ApiType>;
      /**
       * Internal Error
       **/
       ...
       **/
      InvalidCommission: AugmentedError<ApiType>;
      /**
       * Invalid contract
       **/
      InvalidContract: AugmentedError<ApiType>;
      InvalidIASReportSignature: AugmentedError<ApiType>;
       ...
       **/
      InvalidInputBadLength: AugmentedError<ApiType>;
      /**
      ...
      InvalidSignature: AugmentedError<ApiType>;
      InvalidSignatureBadLen: AugmentedError<ApiType>;
      /**
       ...
       **/
      MREnclaveAlreadyExist: AugmentedError<ApiType>;
      /**
       * MRENCLAVE not found
       **/
      MREnclaveNotFound: AugmentedError<ApiType>;
      /**
       ...
       **/
      ReportedWorkerNotMining: AugmentedError<ApiType>;
      /**
       * The reported worker is still alive
       **/
      ReportedWorkerStillAlive: AugmentedError<ApiType>;
      /**
       * Stash not found
       **/
      StashNotFound: AugmentedError<ApiType>;
      /**
       * The off-line report is beyond the slash window
       **/
      TooAncientReport: AugmentedError<ApiType>;
      /**
       * Wrong MRENCLAVE
       **/
      WrongMREnclave: AugmentedError<ApiType>;
      /**
       * Wrong MRENCLAVE whitelist index
       **/
      WrongWhitelistIndex: AugmentedError<ApiType>;
    };
    proxy: {
      [key: string]: AugmentedError<ApiType>;
      /**
