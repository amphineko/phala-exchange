...
import type { AccountId, AccountIndex, Balance, BalanceOf, BlockNumber, Call, CallHashOf, ChangesTrieConfiguration, Hash, Header, KeyValue, LookupSource, Moment, OpaqueCall, Perbill, Percent, Weight } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    miningStaking: {
       ...
       **/
      deposit: AugmentedSubmittable<(value: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BalanceOf]>;
      forceTriggerRoundEnd: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       * Adds some stake to a target
       **/
      stake: AugmentedSubmittable<(to: AccountId | string | Uint8Array, value: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, BalanceOf]>;
      /**
       * Remove some stack from a target
       **/
      unstake: AugmentedSubmittable<(to: AccountId | string | Uint8Array, value: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, BalanceOf]>;
      /**
       * Withdraws some available token from the stash account.
       **/
      withdraw: AugmentedSubmittable<(value: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BalanceOf]>;
    };
    multisig: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    phaClaim: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      changeRelayer: AugmentedSubmittable<(newRelayer: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
      claimErc20Token: AugmentedSubmittable<(account: AccountId | string | Uint8Array, ethTxHash: EthereumTxHash | null, ethSignature: EcdsaSignature | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, EthereumTxHash, EcdsaSignature]>;
      storeErc20BurnedTransactions: AugmentedSubmittable<(height: u64 | AnyNumber | Uint8Array, claims: Vec<ITuple<[EthereumTxHash, EthereumAddress, BalanceOf]>> | ([EthereumTxHash | null, EthereumAddress | string | Uint8Array, BalanceOf | AnyNumber | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [u64, Vec<ITuple<[EthereumTxHash, EthereumAddress, BalanceOf]>>]>;
    };
    phalaModule: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      addMrenclave: AugmentedSubmittable<(mrEnclave: Bytes | string | Uint8Array, mrSigner: Bytes | string | Uint8Array, isvProdId: Bytes | string | Uint8Array, isvSvn: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes, Bytes]>;
      forceAddFire: AugmentedSubmittable<(targets: Vec<AccountId> | (AccountId | string | Uint8Array)[], amounts: Vec<BalanceOf> | (BalanceOf | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId>, Vec<BalanceOf>]>;
      forceNextRound: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      forceRegisterWorker: AugmentedSubmittable<(stash: AccountId | string | Uint8Array, machineId: Bytes | string | Uint8Array, pubkey: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, Bytes, Bytes]>;
      forceResetFire: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      forceSetContractKey: AugmentedSubmittable<(id: u32 | AnyNumber | Uint8Array, pubkey: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, Bytes]>;
      forceSetVirtualTasks: AugmentedSubmittable<(target: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      forceSetWindow: AugmentedSubmittable<(rewardWindow: Option<BlockNumber> | null | object | string | Uint8Array, slashWindow: Option<BlockNumber> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<BlockNumber>, Option<BlockNumber>]>;
      pushCommand: AugmentedSubmittable<(contractId: u32 | AnyNumber | Uint8Array, payload: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, Bytes]>;
      /**
       * Register a worker node with a valid Remote Attestation report
       **/
      registerWorker: AugmentedSubmittable<(encodedRuntimeInfo: Bytes | string | Uint8Array, report: Bytes | string | Uint8Array, signature: Bytes | string | Uint8Array, rawSigningCert: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes, Bytes]>;
      removeMrenclaveByIndex: AugmentedSubmittable<(index: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      removeMrenclaveByRawData: AugmentedSubmittable<(mrEnclave: Bytes | string | Uint8Array, mrSigner: Bytes | string | Uint8Array, isvProdId: Bytes | string | Uint8Array, isvSvn: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes, Bytes, Bytes]>;
      reportOffline: AugmentedSubmittable<(stash: AccountId | string | Uint8Array, blockNum: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId, BlockNumber]>;
      resetWorker: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      /**
       * Update the payout preferences. Must be called by the controller.
       **/
      setPayoutPrefs: AugmentedSubmittable<(payoutCommission: Option<u32> | null | object | string | Uint8Array, payoutTarget: Option<AccountId> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Option<u32>, Option<AccountId>]>;
      /**
       * Crerate a new stash or update an existing one.
       **/
      setStash: AugmentedSubmittable<(controller: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId]>;
      startMiningIntention: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      stopMiningIntention: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      syncWorkerMessage: AugmentedSubmittable<(msg: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      transferToChain: AugmentedSubmittable<(data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      transferToTee: AugmentedSubmittable<(amount: Compact<BalanceOf> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<BalanceOf>]>;
    };
    proxy: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
