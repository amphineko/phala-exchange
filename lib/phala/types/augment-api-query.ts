...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    miningStaking: {
      [key: string]: QueryableStorageEntry<ApiType>;
      pendingStaking: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId, AccountId]> & QueryableStorageEntry<ApiType, [AccountId, AccountId]>;
      pendingUnstaking: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId, AccountId]> & QueryableStorageEntry<ApiType, [AccountId, AccountId]>;
      staked: AugmentedQueryDoubleMap<ApiType, (key1: AccountId | string | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId, AccountId]> & QueryableStorageEntry<ApiType, [AccountId, AccountId]>;
      stakeReceived: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      wallet: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * WalletLocked
       **/
      walletLocked: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
    };
    multisig: {
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    phaClaim: {
      [key: string]: QueryableStorageEntry<ApiType>;
      burnedTransactions: AugmentedQuery<ApiType, (arg: EthereumTxHash | null) => Observable<ITuple<[EthereumAddress, BalanceOf]>>, [EthereumTxHash]> & QueryableStorageEntry<ApiType, [EthereumTxHash]>;
      claimState: AugmentedQuery<ApiType, (arg: EthereumTxHash | null) => Observable<bool>, [EthereumTxHash]> & QueryableStorageEntry<ApiType, [EthereumTxHash]>;
      endHeight: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      relayer: AugmentedQuery<ApiType, () => Observable<Option<AccountId>>, []> & QueryableStorageEntry<ApiType, []>;
    };
    phalaModule: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      accumulatedFire: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Total Fire points (1605-II specific)
       **/
      accumulatedFire2: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []> & QueryableStorageEntry<ApiType, []>;
      blockRewardSeeds: AugmentedQuery<ApiType, (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<BlockRewardInfo>, [BlockNumber]> & QueryableStorageEntry<ApiType, [BlockNumber]>;
      /**
       * Number of all commands
       **/
      commandNumber: AugmentedQuery<ApiType, () => Observable<Option<u64>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Number of all computation workers that will be elected in this round
       **/
      computeWorkers: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Contract assignment
       **/
      contractAssign: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<AccountId>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Map from contract id to contract public key (TODO: migrate to real contract key from
       * worker identity key)
       **/
      contractKey: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Bytes>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Fire measures the total reward the miner can get (PoC3 1604-I specific)
       **/
      fire: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * Fire2 measures the total reward the miner can get (PoC3 1605-II specific)
       **/
      fire2: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<BalanceOf>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * Indicates if we force the next round when the block finalized
       **/
      forceNextRound: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Heartbeat counts
       **/
      heartbeats: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u32>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * Ingress message queue
       **/
      ingressSequence: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<u64>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * The last block where a worker has on-chain activity, updated by `sync_worker_message`
       **/
      lastWorkerActivity: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<BlockNumber>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * Map from machine_id to stash
       **/
      machineOwner: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<AccountId>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       * MREnclave Whitelist
       **/
      mrEnclaveWhitelist: AugmentedQuery<ApiType, () => Observable<Vec<Bytes>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
      ...
      payoutComputeReward: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u32>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * The delta of the worker stats applaying at the end of this round due to exiting miners.
       **/
      pendingExitingDelta: AugmentedQuery<ApiType, () => Observable<MinerStatsDelta>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Stash accounts with pending updates
       **/
      pendingUpdate: AugmentedQuery<ApiType, () => Observable<Vec<AccountId>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Miners must submit the heartbeat in `(now - reward_window, now]`
       **/
      rewardWindow: AugmentedQuery<ApiType, () => Observable<BlockNumber>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * The current mining round id
       **/
      round: AugmentedQuery<ApiType, () => Observable<RoundInfo>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Historical round stats; only the current and the last round are kept.
       **/
      roundStatsHistory: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<RoundStats>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Miners could be slashed in `(now - slash_window, now - reward_window]`
       **/
      slashWindow: AugmentedQuery<ApiType, () => Observable<BlockNumber>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Map from controller to stash
       **/
      stash: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<AccountId>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * Map from stash account to stash info (indexed: Stash)
       **/
      stashState: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<StashInfo>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      targetComputeRewardCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      targetOnlineRewardCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      targetVirtualTaskCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Total Power points in this round. Updated at handle_round_ends().
       **/
      totalPower: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      workerComputeReward: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u32>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * Worker Ingress message queue
       **/
      workerIngress: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u64>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
      /**
       * Map from stash account to worker info
       * 
       * (Indexed: MachineOwner, PendingUpdate, PendingExitingDelta, OnlineWorkers, TotalPower)
       **/
      workerState: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<WorkerInfo>, [AccountId]> & QueryableStorageEntry<ApiType, [AccountId]>;
    };
    proxy: {
      [key: string]: QueryableStorageEntry<ApiType>;
      /**
