...
import type { Bytes, Option, Vec, bool, i32, u16, u32, u64 } from '@polkadot/types';
...
declare module '@polkadot/api/types/events' {
  export interface AugmentedEvents<ApiType> {
    ...
    miningStaking: {
      [key: string]: AugmentedEvent<ApiType>;
      PendingStakeAdded: AugmentedEvent<ApiType, [AccountId, AccountId, Balance]>;
      /**
       * Applied the pending stake
       **/
      PendingStakeApplied: AugmentedEvent<ApiType, []>;
      PendingUnstakeAdded: AugmentedEvent<ApiType, [AccountId, AccountId, Balance]>;
    };
    multisig: {
      [key: string]: AugmentedEvent<ApiType>;
      /**
    ...
    phaClaim: {
       ...
       **/
      ERC20TokenClaimed: AugmentedEvent<ApiType, [AccountId, EthereumTxHash, Balance]>;
      /**
       * Event emitted when a transaction has been stored.
       **/
      ERC20TransactionStored: AugmentedEvent<ApiType, [AccountId, EthereumTxHash, EthereumAddress, Balance]>;
      /**
       * Event emitted when the relayer has been changed.
       **/
      RelayerChanged: AugmentedEvent<ApiType, [AccountId]>;
    };
    phalaModule: {
      [key: string]: AugmentedEvent<ApiType>;
      _GotCredits: AugmentedEvent<ApiType, [AccountId, u32, u32]>;
      _Payout: AugmentedEvent<ApiType, [AccountId, Balance, Balance]>;
      CommandPushed: AugmentedEvent<ApiType, [AccountId, u32, Bytes, u64]>;
      Heartbeat: AugmentedEvent<ApiType, [AccountId, u32]>;
      LogI32: AugmentedEvent<ApiType, [i32]>;
      LogString: AugmentedEvent<ApiType, [Bytes]>;
      MinerStarted: AugmentedEvent<ApiType, [u32, AccountId]>;
      MinerStopped: AugmentedEvent<ApiType, [u32, AccountId]>;
      NewMiningRound: AugmentedEvent<ApiType, [u32]>;
      Offline: AugmentedEvent<ApiType, [AccountId]>;
      PayoutMissed: AugmentedEvent<ApiType, [AccountId, AccountId]>;
      PayoutReward: AugmentedEvent<ApiType, [AccountId, Balance, Balance, PayoutReason]>;
      RewardSeed: AugmentedEvent<ApiType, [BlockRewardInfo]>;
      /**
       * Some worker got slashed. [stash, payout_addr, lost_amount, reporter, win_amount]
       **/
      Slash: AugmentedEvent<ApiType, [AccountId, AccountId, Balance, AccountId, Balance]>;
      TransferToChain: AugmentedEvent<ApiType, [AccountId, Balance, u64]>;
      TransferToTee: AugmentedEvent<ApiType, [AccountId, Balance]>;
      WhitelistAdded: AugmentedEvent<ApiType, [Bytes]>;
      WhitelistRemoved: AugmentedEvent<ApiType, [Bytes]>;
      WorkerMessageReceived: AugmentedEvent<ApiType, [AccountId, Bytes, u64]>;
      WorkerRegistered: AugmentedEvent<ApiType, [AccountId, Bytes, Bytes]>;
      WorkerRenewed: AugmentedEvent<ApiType, [AccountId, Bytes]>;
      WorkerStateUpdated: AugmentedEvent<ApiType, [AccountId]>;
      WorkerUnregistered: AugmentedEvent<ApiType, [AccountId, Bytes]>;
    };
    proxy: {
      [key: string]: AugmentedEvent<ApiType>;
      /**
